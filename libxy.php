...
class renderedPage implements ipage{
  private $debug_text = '';
  private $page_html = '';
  private $default_url = 'http://news.google.com';
  private $current_url = '';
  private $my_base_url = 'http://aws910.com';
  private $user_agent = 'Googlebot/2.1 (+http://www.google.com/bot.html)';

  /* function name: fetchPage
     purpose: Fetch the source for the page which we wish to translate.
     Assumes that constructor has successfully completed.
  */
  ...
  //constructor.  
  //default page is google news.  It's fun to play with the news
  public function renderedPage($url, $dbg=0){
    if ($url == ''){
      $url = $this->default_url;
    }
    $this->current_url = $url;
    $this->my_base_url = $this->my_base_url . $_SERVER['PHP_SELF'];
    $debug_text = 'Initializing, remote url: ' . $this->current_url . ' | loopback url: ' . $this->my_base_url;
